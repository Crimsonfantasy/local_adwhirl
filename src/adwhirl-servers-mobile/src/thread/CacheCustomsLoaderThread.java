...
*/	
	private  List<HashMap<String, Object>> customsList;
	private int threadId;
	
	public CacheCustomsLoaderThread(List<HashMap<String, Object>> customsList, int threadId) {
...
*/
	    ...
	    Iterator<HashMap<String, Object>> iterator = customsList.iterator();
