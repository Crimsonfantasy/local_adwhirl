...
class HouseAd extends SDBObject {
  ...
  public static $HOUSEAD_BUCKET = 'my-adwhirl-sdb-bucket';
  	 //'CHANGEME';


  public static $HOUSEAD_BUCKET_PREFIX = 'http://s3.amazonaws.com/';

  public static $HOUSEAD_AWS_KEY = 'AKIAJPAJZOTA2YJVYQ2A';
  	 //'CHANGEME';


  public static $HOUSEAD_AWS_SECRET = 'P9Xs0eJAqBHgatEujqkrqaRWCusbwaKMcG7NIjdH';
  	 // 'CHANGEME';
