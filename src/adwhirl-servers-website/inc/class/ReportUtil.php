...
*/
	...
	$where = "where $keyName = '$aid' and dateTime >= '$startDate' and dateTime <= '$endDate' " ;
	$my_pdo->select(Report::$SDBDomain , $where,$aaa);
 ...
 */
    ...
    $my_pdo = myPDO::getinstance();
    $where = "where nid = '$cid' and dateTime >= '$startDate' and dateTime <= '$endDate' " ;
    $my_pdo->select(Report::$SDBDomain , $where,$aaa);
...
*/      
      ...
      $where = "where aid = '$aid' and dateTime >= '$startDate' and dateTime <= '$endDate' " ;
      $my_pdo->select(Report::$SDBDomain , $where,$aaa);
