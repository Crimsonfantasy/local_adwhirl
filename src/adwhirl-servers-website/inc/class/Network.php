...
class Network extends SDBObject {
  ...
  public static $NETWORKS = array(Network::NETWORK_TYPE_ADMOB => array('name' => 'AdMob',
				  ...
				  Network::NETWORK_TYPE_GREYSTRIPE => array('name' => 'Greystripe', 
									    'Website' => 'http://www.greystripe.com/', 'keyinfo' => array('API Key'), 'iphone' => false, 'android' => false),
				  Network::NETWORK_TYPE_IAD =>  array('name' => 'iAd', 'Website' => 
								      ...
								      'keyinfo' => array('Apple ID'), 'iphone' => false, 'android' => false),
				  Network::NETWORK_TYPE_INMOBI => array('name' => 'InMobi (legacy only)', 'keyinfo' => array('API Key'), 'iphone' => false, 'android' => false),
				  Network::NETWORK_TYPE_JUMPTAP => array('name' => 'Jumptap',
									 'Website' => 'http://www.jumptap.com','keyinfo' => array('PublisherID', 'SiteID', 'SpotID'), 'iphone' => false, 'android' => false),
				  Network::NETWORK_TYPE_MDOTM => array('name' => 'MdotM',
								       'Website' => 'http://www.mdotm.com/', 'keyinfo' => array('API Key'), 'iphone' => false, 'android' => false),
				  ...
				  Network::NETWORK_TYPE_MOBCLIX => array('name' => 'MobClix (legacy only)', 'Website' => 'http://www.mobclix.com',
									 'keyinfo' => array('API Key'), 'iphone' => false, 'android' => false),
				  ...
				  Network::NETWORK_TYPE_VIDEOEGG => array('name' => 'VideoEgg',	'Website' => 'http://www.videoegg.com/',
									  'keyinfo' => array('PartnerID', 'SiteID'), 'iphone' => false, 'android' => false),
...
,Network::NETWORK_TYPE_KUSOGI => array('name' => 'KuSoGi', 'Website' => 'http://www.kusogi.com/' , 'keyinfo' => array('API Key'), 'iphone' =>true , 'android' => true));
...
*/
  ...
  function postGet() {
    ...
    $this->keys = explode(Network::KEY_SPLIT, $this->adKey);
  }
  ...
  function prePut() {
  	 ...
  	 */
    if (!empty($this->keys))
      $this->adKey = implode(Network::KEY_SPLIT, $this->keys);
  }
}
