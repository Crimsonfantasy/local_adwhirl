...
class SDB {
  ...
  private static $SDB_ACCESS_KEY_ID = 'AKIAJPAJZOTA2YJVYQ2A';
  	  // 'CHANGEME';


  private static $SDB_SECRET_ACCESS_KEY = 'P9Xs0eJAqBHgatEujqkrqaRWCusbwaKMcG7NIjdH';
  	  // 'CHANGEME';
  ...
  public function select($domain, &$aaa, $where, $showAliveOnly=true, $attempts=2) {
    ...
    //cheng
    $my_log->write($select,__FILE__,__LINE__);
