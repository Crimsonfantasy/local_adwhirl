        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i50 = 0; _i50 < _size46; ++_i50)
            {
              ...
              std::string& _val52 = this->index_options[_key51];
...
uint32_t ColumnDef::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.index_options) {
    xfer += oprot->writeFieldBegin("index_options", ::apache::thrift::protocol::T_MAP, 5);
    {
      ...
      for (_iter53 = this->index_options.begin(); _iter53 != this->index_options.end(); ++_iter53)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->column_metadata.resize(_size54);
            uint32_t _i58;
            for (_i58 = 0; _i58 < _size54; ++_i58)
            {
              xfer += this->column_metadata[_i58].read(iprot);
            }
            iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i63 = 0; _i63 < _size59; ++_i63)
            {
              ...
              std::string& _val65 = this->compaction_strategy_options[_key64];
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i70 = 0; _i70 < _size66; ++_i70)
            {
              ...
              std::string& _val72 = this->compression_options[_key71];
...
uint32_t CfDef::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.column_metadata) {
    xfer += oprot->writeFieldBegin("column_metadata", ::apache::thrift::protocol::T_LIST, 13);
    {
      ...
      std::vector<ColumnDef> ::const_iterator _iter73;
      for (_iter73 = this->column_metadata.begin(); _iter73 != this->column_metadata.end(); ++_iter73)
      {
  ...
  if (this->__isset.compaction_strategy_options) {
    xfer += oprot->writeFieldBegin("compaction_strategy_options", ::apache::thrift::protocol::T_MAP, 30);
    {
      ...
      for (_iter74 = this->compaction_strategy_options.begin(); _iter74 != this->compaction_strategy_options.end(); ++_iter74)
      {
  ...
  if (this->__isset.compression_options) {
    xfer += oprot->writeFieldBegin("compression_options", ::apache::thrift::protocol::T_MAP, 32);
    {
      ...
      for (_iter75 = this->compression_options.begin(); _iter75 != this->compression_options.end(); ++_iter75)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i80 = 0; _i80 < _size76; ++_i80)
            {
              ...
              std::string& _val82 = this->strategy_options[_key81];
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->cf_defs.resize(_size83);
            uint32_t _i87;
            for (_i87 = 0; _i87 < _size83; ++_i87)
            {
              xfer += this->cf_defs[_i87].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_cf_defs = true;
...
uint32_t KsDef::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.strategy_options) {
    xfer += oprot->writeFieldBegin("strategy_options", ::apache::thrift::protocol::T_MAP, 3);
    {
      ...
      for (_iter88 = this->strategy_options.begin(); _iter88 != this->strategy_options.end(); ++_iter88)
      {
  ...
  xfer += oprot->writeFieldBegin("cf_defs", ::apache::thrift::protocol::T_LIST, 5);
  {
    ...
    std::vector<CfDef> ::const_iterator _iter89;
    for (_iter89 = this->cf_defs.begin(); _iter89 != this->cf_defs.end(); ++_iter89)
    {
...
uint32_t CqlRow::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->columns.size()));
    std::vector<Column> ::const_iterator _iter95;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i100 = 0; _i100 < _size96; ++_i100)
            {
              ...
              std::string& _val102 = this->name_types[_key101];
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              std::string _key108;
              xfer += iprot->readBinary(_key108);
              std::string& _val109 = this->value_types[_key108];
...
uint32_t CqlMetadata::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("name_types", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    for (_iter110 = this->name_types.begin(); _iter110 != this->name_types.end(); ++_iter110)
    {
  ...
  xfer += oprot->writeFieldBegin("value_types", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    for (_iter111 = this->value_types.begin(); _iter111 != this->value_types.end(); ++_iter111)
    {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (CqlResultType::type)ecast112;
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->rows.resize(_size113);
            uint32_t _i117;
            for (_i117 = 0; _i117 < _size113; ++_i117)
            {
              xfer += this->rows[_i117].read(iprot);
            }
            iprot->readListEnd();
          }
...
uint32_t CqlResult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.rows) {
    xfer += oprot->writeFieldBegin("rows", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      std::vector<CqlRow> ::const_iterator _iter118;
      for (_iter118 = this->rows.begin(); _iter118 != this->rows.end(); ++_iter118)
      {
