    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast119;
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast120;
          isset_consistency_level = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t Cassandra_get_slice_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<ColumnOrSuperColumn> ::const_iterator _iter126;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i145 = 0; _i145 < _size141; ++_i145)
            {
              ...
              std::vector<ColumnOrSuperColumn> & _val147 = this->success[_key146];
              {
                _val147.clear();
                uint32_t _size148;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i159 = 0; _i159 < _size155; ++_i159)
            {
              ...
              std::vector<ColumnOrSuperColumn> & _val161 = (*(this->success))[_key160];
              {
                _val161.clear();
                uint32_t _size162;
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->keys.resize(_size167);
            uint32_t _i171;
            for (_i171 = 0; _i171 < _size167; ++_i171)
            {
              xfer += iprot->readBinary(this->keys[_i171]);
            }
            iprot->readListEnd();
          }
          isset_keys = true;
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast172;
          isset_consistency_level = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t Cassandra_multiget_count_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("keys", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter173 = this->keys.begin(); _iter173 != this->keys.end(); ++_iter173)
    {
      xfer += oprot->writeBinary((*_iter173));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
uint32_t Cassandra_multiget_count_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("keys", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter174 = (*(this->keys)).begin(); _iter174 != (*(this->keys)).end(); ++_iter174)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              std::string _key180;
              xfer += iprot->readBinary(_key180);
              int32_t& _val181 = this->success[_key180];
              xfer += iprot->readI32(_val181);
            }
            iprot->readMapEnd();
          }
          this->__isset.success = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i187 = 0; _i187 < _size183; ++_i187)
            {
              ...
              int32_t& _val189 = (*(this->success))[_key188];
              xfer += iprot->readI32(_val189);
            }
            iprot->readMapEnd();
          }
          this->__isset.success = true;
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast190;
          isset_consistency_level = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t Cassandra_get_range_slices_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<KeySlice> ::const_iterator _iter196;
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast215;
          isset_consistency_level = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast216;
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->consistency_level = (ConsistencyLevel::type)ecast217;
          isset_consistency_level = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              std::string _key223;
              xfer += iprot->readBinary(_key223);
              std::map<std::string, std::vector<Mutation> > & _val224 = this->mutation_map[_key223];
              {
                _val224.clear();
                uint32_t _size225;
...
uint32_t Cassandra_batch_mutate_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("mutation_map", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    std::map<std::string, std::map<std::string, std::vector<Mutation> > > ::const_iterator _iter238;
    for (_iter238 = this->mutation_map.begin(); _iter238 != this->mutation_map.end(); ++_iter238)
    {
      xfer += oprot->writeBinary(_iter238->first);
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_LIST, static_cast<uint32_t>(_iter238->second.size()));
        std::map<std::string, std::vector<Mutation> > ::const_iterator _iter239;
        for (_iter239 = _iter238->second.begin(); _iter239 != _iter238->second.end(); ++_iter239)
        {
          xfer += oprot->writeString(_iter239->first);
          {
            xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter239->second.size()));
...
uint32_t Cassandra_batch_mutate_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_MAP, static_cast<uint32_t>((*(this->mutation_map)).size()));
    std::map<std::string, std::map<std::string, std::vector<Mutation> > > ::const_iterator _iter241;
    for (_iter241 = (*(this->mutation_map)).begin(); _iter241 != (*(this->mutation_map)).end(); ++_iter241)
    {
      xfer += oprot->writeBinary(_iter241->first);
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_LIST, static_cast<uint32_t>(_iter241->second.size()));
        std::map<std::string, std::vector<Mutation> > ::const_iterator _iter242;
        for (_iter242 = _iter241->second.begin(); _iter242 != _iter241->second.end(); ++_iter242)
        {
          xfer += oprot->writeString(_iter242->first);
          {
            xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter242->second.size()));
            std::vector<Mutation> ::const_iterator _iter243;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype245, _vtype246, _size244);
            uint32_t _i248;
            for (_i248 = 0; _i248 < _size244; ++_i248)
            {
              std::string _key249;
              xfer += iprot->readString(_key249);
              std::vector<std::string> & _val250 = this->success[_key249];
              {
                _val250.clear();
                uint32_t _size251;
                ::apache::thrift::protocol::TType _etype254;
                iprot->readListBegin(_etype254, _size251);
                _val250.resize(_size251);
                uint32_t _i255;
                for (_i255 = 0; _i255 < _size251; ++_i255)
                {
                  xfer += iprot->readString(_val250[_i255]);
                }
                iprot->readListEnd();
              }
            }
...
uint32_t Cassandra_describe_schema_versions_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_LIST, static_cast<uint32_t>(this->success.size()));
      std::map<std::string, std::vector<std::string> > ::const_iterator _iter256;
      for (_iter256 = this->success.begin(); _iter256 != this->success.end(); ++_iter256)
      {
        xfer += oprot->writeString(_iter256->first);
        {
          xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(_iter256->second.size()));
          std::vector<std::string> ::const_iterator _iter257;
          for (_iter257 = _iter256->second.begin(); _iter257 != _iter256->second.end(); ++_iter257)
          {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i262 = 0; _i262 < _size258; ++_i262)
            {
              ...
              std::vector<std::string> & _val264 = (*(this->success))[_key263];
              {
                _val264.clear();
                uint32_t _size265;
                ::apache::thrift::protocol::TType _etype268;
                iprot->readListBegin(_etype268, _size265);
                _val264.resize(_size265);
                uint32_t _i269;
                for (_i269 = 0; _i269 < _size265; ++_i269)
                {
                  xfer += iprot->readString(_val264[_i269]);
                }
                iprot->readListEnd();
              }
            }
...
uint32_t Cassandra_describe_keyspaces_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<KsDef> ::const_iterator _iter275;
...
uint32_t Cassandra_describe_ring_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<TokenRange> ::const_iterator _iter286;
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->compression = (Compression::type)ecast303;
