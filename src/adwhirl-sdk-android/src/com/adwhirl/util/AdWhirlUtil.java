...
/**
    Cheng change content below . The origin version is above;  
 */
  

	
	  /**
	   * cheng add (my service)
	   */
    /**
	public static final String urlConfig = "http://ec2-107-20-202-192.compute-1.amazonaws.com:80/getInfo.php?appid=%s&appver=%d&client=2";
	public static final String urlImpression = "http://ec2-107-20-202-192.compute-1.amazonaws.com:80/exmet.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlClick = "http://ec2-107-20-202-192.compute-1.amazonaws.com:80/exclick.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
 	public static final String urlCustom = "http://ec2-107-20-202-192.compute-1.amazonaws.com:80/custom.php?appid=%s&nid=%s&uuid=%s&country_code=%s%s&appver=%d&client=2";
	*/
	
	
	
	  /**
	   * cheng add (kusogi service)
	   */
	/**
	public static final String urlConfig = "http://ec2-107-22-245-54.compute-1.amazonaws.com:80/getInfo.php?appid=%s&appver=%d&client=2";
	public static final String urlImpression = "http://ec2-107-22-245-54.compute-1.amazonaws.com:80/exmet.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlClick = "http://ec2-107-22-245-54.compute-1.amazonaws.com:80/exclick.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlCustom = "http://ec2-107-22-245-54.compute-1.amazonaws.com:80/custom.php?appid=%s&nid=%s&uuid=%s&country_code=%s%s&appver=%d&client=2";
	*/
	
	
	/**
	 * 
	 * cheng add(selab service)
	 */
	
	public static final String urlConfig = "http://140.134.26.12:80/getInfo.php?appid=%s&appver=%d&client=2";
	public static final String urlImpression = "http://140.134.26.12:80/exmet.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlClick = "http://140.134.26.12:80/exclick.php?appid=%s&nid=%s&type=%d&uuid=%s&country_code=%s&appver=%d&client=2";
	public static final String urlCustom = "http://140.134.26.12:80/custom.php?appid=%s&nid=%s&uuid=%s&country_code=%s%s&appver=%d&client=2";
  ...
  public static final int NETWORK_TYPE_KUSOGI = 21; 
  /**
   * cheng add
   */
